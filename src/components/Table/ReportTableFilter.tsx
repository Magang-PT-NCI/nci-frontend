  ...
  return (
    <View className='w-full'>
      ...
      <View className='w-full flex-row items-center px-3 py-2 rounded-xl bg-customGray border border-accentGreen mb-4'>
        ...
        <TextInput className='w-full text-textDefault ml-2'
        placeholder='Cari ...'
      ...
      <View className='w-1/2 flex flex-row gap-4 mb-2'>
        ...
        <View>
          ...
          <DateItem key={'start_date'} type='inner' onDateChange={handleStartDateChange}/>
        </View>

        <View>
          <Text className='text-accentYellow mb-2'>Tanggal Akhir</Text>
          <DateItem key={'end_date'}type='inner'onDateChange={handleEndDateChange}/>
        </View>
